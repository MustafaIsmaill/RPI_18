...
class ROV:
    def __init__(self):
        ...
        self._myhardware._avrList[1].addDevice("Camera_Servo",cameraservobase,2)
        ...
        self._rovmotion=Motion(self._myhardware,{"x":0,"y":0,"z":0,"r":0,"currentmode":"normal"})
        modules=[self._rovmanipulator,self._rovLights,self._rovCamera,self._rovmotion]
        ...
        self.mypostoffice.registerEventListner("I2C",self._rovmanipulator.mail)
        self.mypostoffice.registerEventListner("I2C",self._myhardware._avrList[1].mail)
