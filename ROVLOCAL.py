...
class ROVLOCAL:
    def __init__(self):
        ...
        self._rovLights = Light1(self._myhardware, {"led": 0})
        self._rovCamera = Camera(self._myhardware, {"cam": 0})
        self._rovmotion = Motion(self._myhardware, {"x": 0, "y": 0, "z": 0, "r": 0, "currentmode": 0})
        modules = [self._rovCamera, self._rovmotion,self._rovmanipulator,self._rovLights]
