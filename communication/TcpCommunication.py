    ...
    def _accept(self, x=None, y=None):
        ...
        try:
            if self._videoStreamingEnable:
                ...
                self._pipeline2 = "v4l2src device=/dev/video1 ! video/x-raw,framerate=30/1,width=640,height=480 ! videoconvert ! x264enc pass=qual quantizer=20 tune=zerolatency ! rtph264pay ! multiudpsink clients=" + self._streamingIP + ":" + self._streamingPort3 + "," + self._streamingIP + ":" + self._streamingPort4 +" sync=false"
