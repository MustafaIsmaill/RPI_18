...
class Motion(Component):
    ...
    def _calculateHorizontalMotors_17(self):
        ...
        right_front_thruster_value = 0.5 * (front_right_thruster_value - self.PWMNORMAL) + self.PWMNORMAL
        left_front_thruster_value = 0.5 * (front_left_thruster_value - self.PWMNORMAL) + self.PWMNORMAL
        right_rear_thruster_value = 0.5 * (back_right_thruster_value - self.PWMNORMAL) + self.PWMNORMAL
        left_rear_thruster_value = 0.5 * (back_left_thruster_value - self.PWMNORMAL) + self.PWMNORMAL
    ...
    def _calculateVerticalMotors_NormalMode(self):
        ...
        if self._valueMap['up']:
            top_front_thruster_value = int(self.PWMNORMAL + (self._valueMap['z']*0.5*(self.PWMRANGE/100)))
            top_rear_thruster_value = int(self.PWMNORMAL + (self._valueMap['z']*0.5*(self.PWMRANGE/100)))
